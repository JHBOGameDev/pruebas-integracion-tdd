...
public class RegistryTest {
    ...
    public void shouldReturnUnderAge() {
        // Arrange
        Person person = new Person("Juan",101,15,Gender.MALE,true);
    ...
    public void shouldReturnDead() {
        // Arrange
        Person person = new Person("Carlos",102,40,Gender.MALE,false);
    ...
    public void shouldReturnInvalidWhenIdIsNegative() {
        // Arrange
        Person person = new Person("Pedro",-1,30,Gender.MALE,true);
    ...
    @Test
    public void shouldHandleConnectionErrorGracefully() {
        // Arrange: repositorio con URL de conexión inválida
        RegistryRepository badRepo = new RegistryRepository("jdbc:h2:mem:");
        Registry badRegistry = new Registry(badRepo);
        Person person = new Person("Test", 999, 25, Gender.MALE, true);
        // Act & Assert: el sistema debe manejar el error sin colapsar
        try {
            RegisterResult result = badRegistry.registerVoter(person);
    ...
    public void shouldFindPersonById() throws Exception {
        ...
        // Act
        Optional<RegistryRecord> found = repo.findById(200);
    ...
    @Test
    public void shouldConnectWithUsernameAndPassword() throws Exception {
        // Arrange: repositorio con constructor completo
        RegistryRepository repoWithCredentials = new RegistryRepository(
                "jdbc:h2:mem:regdb;DB_CLOSE_DELAY=-1", "", "");
        repoWithCredentials.initSchema();

        // Act
        boolean exists = repoWithCredentials.existsById(999);
